...
object DataProviderManager {
    var name:String = "OkName"
    fun registerDataProvider(provider:DataProvider) {}

    val allDataProviders:Collection<DataProvider>
        get() = listOf(DataProvider("ok"))
}
...
class MyClass11 {
    companion object Factory {
        fun create(): MyClass11 = MyClass11()
    }
}

val instance = MyClass11.create()   // 访问到对象的内部元素
...
class MyClass13 {
    companion object : Factory<MyClass13> {
        override fun create(): MyClass13 = MyClass13()
    }
}
